...
public class Mapa {
  ...
  //================================================================================================================
   ...
   // esta segunda version no la probe, se lo debe invocar desde el metodo publico asi: 
   //caminoMasCortoHelper(origen, destino, new LinkedList<String>, new LinkedList<String> , 0,marca, Integer.MAX_VALUE);
   private int caminoMasCortoHelper(Vertex<String> actual, Vertex<String> destino, List<String> listaActual,List<String> listaMin, int distanciaAct, boolean[] marca,int min)
   {       
       marca[actual.getPosition()] = true ;
       listaActual.add(actual.getData());
       ...
       else
       {
           ...
           while (iterador.hasNext() && distanciaAct < min)
           {
               ...
               if (!marca[j] && total < min)
                   min = caminoMasCortoHelper(e.getTarget(), destino, listaActual, listaMin, distanciaAct, marca,min);
           }
       }
